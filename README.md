...
- [mouseless](https://github.com/jbensmann/mouseless): A replacement for the mouse in Linux that works as a key remapper with layers, key combo and tap-hold capabilities
