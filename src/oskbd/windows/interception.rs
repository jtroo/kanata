    ...
    fn from_mouse_btn(btn: Btn, is_up: bool) -> Self {
        Self(Stroke::Mouse {
            state: match (btn, is_up) {
                ...
                (Btn::Side, true) => MouseState::BUTTON_4_DOWN,
                (Btn::Side, false) => MouseState::BUTTON_4_UP,
                (Btn::Extra, true) => MouseState::BUTTON_5_DOWN,
                (Btn::Extra, false) => MouseState::BUTTON_5_UP,
            },
