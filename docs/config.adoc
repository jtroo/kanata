...
**linux-x11-repeat-delay-rate[[linux-only-x11-repeat-rate]]**
...
**windows-interception-mouse-hwid[[windows-only-windows-interception-mouse-hwid]]**
...
**windows-interception-mouse-hwids[[windows-only-windows-interception-mouse-hwids]]**
...
**windows-interception-keyboard-hwids[[windows-only-windows-interception-keyboard-hwids]]**
