...
If viewing on GitHub, see the triple bullet-lines at the upper right
to open or close a Table of Contents sidebar.

The **Reference** sections is brief text
intended for reviewing how precisely to configure items.
