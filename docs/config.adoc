...
The intended use case is accelerating and reducing effort of typing.
The inputs are keycodes and the outputs are also purely keycodes.
In other words, all other actions are unsupported;
e.g. layers, switch, one-shot.

Unlike chords(v1) and chordsv2, zippychord behaves on output keycodes.
